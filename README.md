...
The utility functions implemented in this project have been divided into number and text utilities. The number utilities include a number base converter and a summary statistics calculator. The text utilities include a palindrome checker and word frequency counter.
